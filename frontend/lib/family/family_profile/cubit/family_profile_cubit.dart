...
import '../data/family_profile_dummy_data.dart';
...
class FamilyProfileCubit extends Cubit<FamilyProfileState> {
  FamilyProfileCubit()
      : super(
    FamilyProfileState(
      name: FamilyProfileDummyData.name,
      email: FamilyProfileDummyData.email,
      phone: FamilyProfileDummyData.phone,
      address: FamilyProfileDummyData.address,
      gender: FamilyProfileDummyData.gender,
      dateOfBirth: FamilyProfileDummyData.dateOfBirth,
    ),
  ) {
    _lastSaved = state;
  }
