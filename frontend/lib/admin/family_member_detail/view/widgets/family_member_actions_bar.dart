...
/// matching this design (and now consistent with Elderly Profile's
/// action bar too, which uses the same shape).
class FamilyMemberActionsBar extends StatelessWidget {
  const FamilyMemberActionsBar({
